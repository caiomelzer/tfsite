...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2016 at 07:55 PM
...
CREATE DEFINER=`terraqli`@`localhost` PROCEDURE `prc_associados_ativacao` (IN `p_email` VARCHAR(50))  BEGIN
  UPDATE associados
     SET Ativo = 1
   WHERE Email = p_email
       ;
...
CREATE DEFINER=`terraqli`@`localhost` PROCEDURE `prc_associados_del` (IN `p_associado_id` INT)  BEGIN
...
CREATE DEFINER=`terraqli`@`localhost` PROCEDURE `prc_associados_ins` (IN `p_Email` VARCHAR(50), IN `p_Dependente` INT, IN `p_Responsavel` VARCHAR(50), IN `p_LoginExterno` INT, IN `p_NomeCompleto` VARCHAR(100), IN `p_Senha` VARCHAR(32), IN `p_DtNascimento` DATE, IN `p_Sexo` INT)  BEGIN
...
CREATE DEFINER=`terraqli`@`localhost` PROCEDURE `prc_associados_upd` (IN `p_id` INT, IN `p_nome` VARCHAR(100), IN `p_mae` VARCHAR(100), IN `p_pai` VARCHAR(100), IN `p_cpf` VARCHAR(11), IN `p_rg` VARCHAR(10), IN `p_nacionalidade` INT)  BEGIN
...
CREATE DEFINER=`terraqli`@`localhost` PROCEDURE `prc_categoria_futebol_Ins` (IN `p_categoria_descricao` VARCHAR(50), IN `p_categoria_descricaocompl` VARCHAR(100))  BEGIN
DECLARE EXIT HANDLER FOR SQLSTATE '23000'
  BEGIN 
...
CREATE TABLE IF NOT EXISTS `associados` (
  `Associado_Id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primaria do Associado - Número Sequencial',
  ...
  UNIQUE KEY `UK_associado` (`NomeCompleto`,`Email`,`DtNascimento`)
...
CREATE TABLE IF NOT EXISTS `categorias_futebol` (
  `categoria_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'chave primaria',
  ...
  UNIQUE KEY `uk_categoria` (`categoria_descricao`),
  KEY `pk_categoria` (`categoria_id`)
...
CREATE TABLE IF NOT EXISTS `cidades` (
  `Cidade_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primaria',
  ...
  KEY `pk_cidades` (`Cidade_id`),
  KEY `fk_cidade_estado` (`Cidade_Estadoid`)
...
(82, 'Bujari', 30),
(83, 'Capixaba', 30),
(84, 'Cruzeiro do Sul', 30),
(85, 'Epitaciolândia', 30),
(86, 'Feijó', 30),
(87, 'Jordão', 30),
(88, 'Mâncio Lima', 30),
(89, 'Manoel Urbano', 30),
(90, 'Marechal Thaumaturgo', 30),
(91, 'Plácido de Castro', 30),
(92, 'Porto Acre', 30),
(93, 'Porto Walter', 30),
(94, 'Rio Branco', 30),
(95, 'Rodrigues Alves', 30),
(96, 'Santa Rosa do Purus', 30),
(97, 'Sena Madureira', 30),
(98, 'Senador Guiomard', 30),
(99, 'Tarauacá', 30),
(100, 'Xapuri', 30),
(101, 'Água Branca', 2),
(102, 'Anadia', 2),
...
CREATE TABLE IF NOT EXISTS `convitejogo` (
  ...
  KEY `fk_Convite_equipe1` (`Equipe_Id`),
  KEY `fk_Convite_equipe2` (`EquipeConvidada_Id`),
  KEY `fk_Convite_Enderecos` (`EnderecoJogoId`)
...
CREATE TABLE IF NOT EXISTS `convitejogo_retorno` (
  `ConviteRetorno_Id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária',
  ...
  KEY `pk_convitejogoretorno` (`ConviteRetorno_Id`),
  KEY `fk_conviteretornojogo_convite` (`Convite_Id`)
...
INSERT INTO `countries` (`id`, `name`, `language`, `flag`, `actived`, `lang`, `ido`) VALUES
(1, 'Afghanistan', 'AF', NULL, 0, '', 1),
(2, 'Albania', 'AL', NULL, 0, '', 2),
(3, 'Algeria', 'DZ', NULL, 0, '', 3),
(4, 'American Samoa', 'DS', NULL, 0, '', 4),
(5, 'Andorra', 'AD', NULL, 0, '', 5),
(6, 'Angola', 'AO', NULL, 0, '', 6),
(7, 'Anguilla', 'AI', NULL, 0, '', 7),
(8, 'Antarctica', 'AQ', NULL, 0, '', 8),
(9, 'Antigua and Barbuda', 'AG', NULL, 0, '', 9),
(10, 'Argentina', 'AR', NULL, 0, '', 10),
(11, 'Armenia', 'AM', NULL, 0, '', 11),
(12, 'Aruba', 'AW', NULL, 0, '', 12),
(13, 'Australia', 'AU', NULL, 0, '', 13),
(14, 'Austria', 'AT', NULL, 0, '', 14),
(15, 'Azerbaijan', 'AZ', NULL, 0, '', 15),
(16, 'Bahamas', 'BS', NULL, 0, '', 16),
(17, 'Bahrain', 'BH', NULL, 0, '', 17),
(18, 'Bangladesh', 'BD', NULL, 0, '', 18),
(19, 'Barbados', 'BB', NULL, 0, '', 19),
(20, 'Belarus', 'BY', NULL, 0, '', 20),
(21, 'Belgium', 'BE', NULL, 0, '', 21),
(22, 'Belize', 'BZ', NULL, 0, '', 22),
(23, 'Benin', 'BJ', NULL, 0, '', 23),
(24, 'Bermuda', 'BM', NULL, 0, '', 24),
(25, 'Bhutan', 'BT', NULL, 0, '', 25),
(26, 'Bolivia', 'BO', NULL, 0, '', 26),
(27, 'Bosnia and Herzegovina', 'BA', NULL, 0, '', 27),
(28, 'Botswana', 'BW', NULL, 0, '', 28),
(29, 'Bouvet Island', 'BV', NULL, 0, '', 29),
(30, 'Brasil', 'BR', NULL, 1, 'en', 30),
(31, 'British Indian Ocean Territory', 'IO', NULL, 0, '', 31),
(32, 'Brunei Darussalam', 'BN', NULL, 0, '', 32),
(33, 'Bulgaria', 'BG', NULL, 0, '', 33),
(34, 'Burkina Faso', 'BF', NULL, 0, '', 34),
(35, 'Burundi', 'BI', NULL, 0, '', 35),
(36, 'Cambodia', 'KH', NULL, 0, '', 36),
(37, 'Cameroon', 'CM', NULL, 0, '', 37),
(38, 'Canada', 'CA', NULL, 0, '', 38),
(39, 'Cape Verde', 'CV', NULL, 0, '', 39),
(40, 'Cayman Islands', 'KY', NULL, 0, '', 40),
(41, 'Central African Republic', 'CF', NULL, 0, '', 41),
(42, 'Chad', 'TD', NULL, 0, '', 42),
(43, 'Chile', 'CL', NULL, 0, '', 43),
(44, 'China', 'CN', NULL, 0, '', 44),
(45, 'Christmas Island', 'CX', NULL, 0, '', 45),
(46, 'Cocos (Keeling) Islands', 'CC', NULL, 0, '', 46),
(47, 'Colombia', 'CO', NULL, 0, '', 47),
(48, 'Comoros', 'KM', NULL, 0, '', 48),
(49, 'Congo', 'CG', NULL, 0, '', 49),
(50, 'Cook Islands', 'CK', NULL, 0, '', 50),
(51, 'Costa Rica', 'CR', NULL, 0, '', 51),
(52, 'Croatia (Hrvatska)', 'HR', NULL, 0, '', 52),
(53, 'Cuba', 'CU', NULL, 0, '', 53),
(54, 'Cyprus', 'CY', NULL, 0, '', 54),
(55, 'Czech Republic', 'CZ', NULL, 0, '', 55),
(56, 'Denmark', 'DK', NULL, 0, '', 56),
(57, 'Djibouti', 'DJ', NULL, 0, '', 57),
(58, 'Dominica', 'DM', NULL, 0, '', 58),
(59, 'Dominican Republic', 'DO', NULL, 0, '', 59),
(60, 'East Timor', 'TP', NULL, 0, '', 60),
(61, 'Ecuador', 'EC', NULL, 0, '', 61),
(62, 'Egypt', 'EG', NULL, 0, '', 62),
(63, 'El Salvador', 'SV', NULL, 0, '', 63),
(64, 'Equatorial Guinea', 'GQ', NULL, 0, '', 64),
(65, 'Eritrea', 'ER', NULL, 0, '', 65),
(66, 'Estonia', 'EE', NULL, 0, '', 66),
(67, 'Ethiopia', 'ET', NULL, 0, '', 67),
(68, 'Falkland Islands (Malvinas)', 'FK', NULL, 0, '', 68),
(69, 'Faroe Islands', 'FO', NULL, 0, '', 69),
(70, 'Fiji', 'FJ', NULL, 0, '', 70),
(71, 'Finland', 'FI', NULL, 0, '', 71),
(72, 'France', 'FR', NULL, 0, '', 72),
(73, 'France, Metropolitan', 'FX', NULL, 0, '', 73),
(74, 'French Guiana', 'GF', NULL, 0, '', 74),
(75, 'French Polynesia', 'PF', NULL, 0, '', 75),
(76, 'French Southern Territories', 'TF', NULL, 0, '', 76),
(77, 'Gabon', 'GA', NULL, 0, '', 77),
(78, 'Gambia', 'GM', NULL, 0, '', 78),
(79, 'Georgia', 'GE', NULL, 0, '', 79),
(80, 'Germany', 'DE', NULL, 0, '', 80),
(81, 'Ghana', 'GH', NULL, 0, '', 81),
(82, 'Gibraltar', 'GI', NULL, 0, '', 82),
(83, 'Guernsey', 'GK', NULL, 0, '', 83),
(84, 'Greece', 'GR', NULL, 0, '', 84),
(85, 'Greenland', 'GL', NULL, 0, '', 85),
(86, 'Grenada', 'GD', NULL, 0, '', 86),
(87, 'Guadeloupe', 'GP', NULL, 0, '', 87),
(88, 'Guam', 'GU', NULL, 0, '', 88),
(89, 'Guatemala', 'GT', NULL, 0, '', 89),
(90, 'Guinea', 'GN', NULL, 0, '', 90),
(91, 'Guinea-Bissau', 'GW', NULL, 0, '', 91),
(92, 'Guyana', 'GY', NULL, 0, '', 92),
(93, 'Haiti', 'HT', NULL, 0, '', 93),
(94, 'Heard and Mc Donald Islands', 'HM', NULL, 0, '', 94),
(95, 'Honduras', 'HN', NULL, 0, '', 95),
(96, 'Hong Kong', 'HK', NULL, 0, '', 96),
(97, 'Hungary', 'HU', NULL, 0, '', 97),
(98, 'Iceland', 'IS', NULL, 0, '', 98),
(99, 'India', 'IN', NULL, 0, '', 99),
(100, 'Isle of Man', 'IM', NULL, 0, '', 100),
(101, 'Indonesia', 'ID', NULL, 0, '', 101),
(102, 'Iran (Islamic Republic of)', 'IR', NULL, 0, '', 102),
(103, 'Iraq', 'IQ', NULL, 0, '', 103),
(104, 'Ireland', 'IE', NULL, 0, '', 104),
(105, 'Israel', 'IL', NULL, 0, '', 105),
(106, 'Italy', 'IT', NULL, 0, '', 106),
(107, 'Ivory Coast', 'CI', NULL, 0, '', 107),
(108, 'Jersey', 'JE', NULL, 0, '', 108),
(109, 'Jamaica', 'JM', NULL, 0, '', 109),
(110, 'Japan', 'JP', NULL, 0, '', 110),
(111, 'Jordan', 'JO', NULL, 0, '', 111),
(112, 'Kazakhstan', 'KZ', NULL, 0, '', 112),
(113, 'Kenya', 'KE', NULL, 0, '', 113),
(114, 'Kiribati', 'KI', NULL, 0, '', 114),
(115, 'Korea, Democratic People''s Republic of', 'KP', NULL, 0, '', 115),
(116, 'Korea, Republic of', 'KR', NULL, 0, '', 116),
(117, 'Kosovo', 'XK', NULL, 0, '', 117),
(118, 'Kuwait', 'KW', NULL, 0, '', 118),
(119, 'Kyrgyzstan', 'KG', NULL, 0, '', 119),
(120, 'Lao People''s Democratic Republic', 'LA', NULL, 0, '', 120),
(121, 'Latvia', 'LV', NULL, 0, '', 121),
(122, 'Lebanon', 'LB', NULL, 0, '', 122),
(123, 'Lesotho', 'LS', NULL, 0, '', 123),
(124, 'Liberia', 'LR', NULL, 0, '', 124),
(125, 'Libyan Arab Jamahiriya', 'LY', NULL, 0, '', 125),
(126, 'Liechtenstein', 'LI', NULL, 0, '', 126),
(127, 'Lithuania', 'LT', NULL, 0, '', 127),
(128, 'Luxembourg', 'LU', NULL, 0, '', 128),
(129, 'Macau', 'MO', NULL, 0, '', 129),
(130, 'Macedonia', 'MK', NULL, 0, '', 130),
(131, 'Madagascar', 'MG', NULL, 0, '', 131),
(132, 'Malawi', 'MW', NULL, 0, '', 132),
(133, 'Malaysia', 'MY', NULL, 0, '', 133),
(134, 'Maldives', 'MV', NULL, 0, '', 134),
(135, 'Mali', 'ML', NULL, 0, '', 135),
(136, 'Malta', 'MT', NULL, 0, '', 136),
(137, 'Marshall Islands', 'MH', NULL, 0, '', 137),
(138, 'Martinique', 'MQ', NULL, 0, '', 138),
(139, 'Mauritania', 'MR', NULL, 0, '', 139),
(140, 'Mauritius', 'MU', NULL, 0, '', 140),
(141, 'Mayotte', 'TY', NULL, 0, '', 141),
(142, 'Mexico', 'MX', NULL, 0, '', 142),
(143, 'Micronesia, Federated States of', 'FM', NULL, 0, '', 143),
(144, 'Moldova, Republic of', 'MD', NULL, 0, '', 144),
(145, 'Monaco', 'MC', NULL, 0, '', 145),
(146, 'Mongolia', 'MN', NULL, 0, '', 146),
(147, 'Montenegro', 'ME', NULL, 0, '', 147),
(148, 'Montserrat', 'MS', NULL, 0, '', 148),
(149, 'Morocco', 'MA', NULL, 0, '', 149),
(150, 'Mozambique', 'MZ', NULL, 0, '', 150),
(151, 'Myanmar', 'MM', NULL, 0, '', 151),
(152, 'Namibia', 'NA', NULL, 0, '', 152),
(153, 'Nauru', 'NR', NULL, 0, '', 153),
(154, 'Nepal', 'NP', NULL, 0, '', 154),
(155, 'Netherlands', 'NL', NULL, 0, '', 155),
(156, 'Netherlands Antilles', 'AN', NULL, 0, '', 156),
(157, 'New Caledonia', 'NC', NULL, 0, '', 157),
(158, 'New Zealand', 'NZ', NULL, 0, '', 158),
(159, 'Nicaragua', 'NI', NULL, 0, '', 159),
(160, 'Niger', 'NE', NULL, 0, '', 160),
(161, 'Nigeria', 'NG', NULL, 0, '', 161),
(162, 'Niue', 'NU', NULL, 0, '', 162),
(163, 'Norfolk Island', 'NF', NULL, 0, '', 163),
(164, 'Northern Mariana Islands', 'MP', NULL, 0, '', 164),
(165, 'Norway', 'NO', NULL, 0, '', 165),
(166, 'Oman', 'OM', NULL, 0, '', 166),
(167, 'Pakistan', 'PK', NULL, 0, '', 167),
(168, 'Palau', 'PW', NULL, 0, '', 168),
(169, 'Palestine', 'PS', NULL, 0, '', 169),
(170, 'Panama', 'PA', NULL, 0, '', 170),
(171, 'Papua New Guinea', 'PG', NULL, 0, '', 171),
(172, 'Paraguay', 'PY', NULL, 0, '', 172),
(173, 'Peru', 'PE', NULL, 0, '', 173),
(174, 'Philippines', 'PH', NULL, 0, '', 174),
(175, 'Pitcairn', 'PN', NULL, 0, '', 175),
(176, 'Poland', 'PL', NULL, 0, '', 176),
(177, 'Portugal', 'PT', NULL, 0, '', 177),
(178, 'Puerto Rico', 'PR', NULL, 0, '', 178),
(179, 'Qatar', 'QA', NULL, 0, '', 179),
(180, 'Reunion', 'RE', NULL, 0, '', 180),
(181, 'Romania', 'RO', NULL, 0, '', 181),
(182, 'Russian Federation', 'RU', NULL, 0, '', 182),
(183, 'Rwanda', 'RW', NULL, 0, '', 183),
(184, 'Saint Kitts and Nevis', 'KN', NULL, 0, '', 184),
(185, 'Saint Lucia', 'LC', NULL, 0, '', 185),
(186, 'Saint Vincent and the Grenadines', 'VC', NULL, 0, '', 186),
(187, 'Samoa', 'WS', NULL, 0, '', 187),
(188, 'San Marino', 'SM', NULL, 0, '', 188),
(189, 'Sao Tome and Principe', 'ST', NULL, 0, '', 189),
(190, 'Saudi Arabia', 'SA', NULL, 0, '', 190),
(191, 'Senegal', 'SN', NULL, 0, '', 191),
(192, 'Serbia', 'RS', NULL, 0, '', 192),
(193, 'Seychelles', 'SC', NULL, 0, '', 193),
(194, 'Sierra Leone', 'SL', NULL, 0, '', 194),
(195, 'Singapore', 'SG', NULL, 0, '', 195),
(196, 'Slovakia', 'SK', NULL, 0, '', 196),
(197, 'Slovenia', 'SI', NULL, 0, '', 197),
(198, 'Solomon Islands', 'SB', NULL, 0, '', 198),
(199, 'Somalia', 'SO', NULL, 0, '', 199),
(200, 'South Africa', 'ZA', NULL, 0, '', 200),
(201, 'South Georgia South Sandwich Islands', 'GS', NULL, 0, '', 201),
(202, 'Spain', 'ES', NULL, 0, '', 202),
(203, 'Sri Lanka', 'LK', NULL, 0, '', 203),
(204, 'St. Helena', 'SH', NULL, 0, '', 204),
(205, 'St. Pierre and Miquelon', 'PM', NULL, 0, '', 205),
(206, 'Sudan', 'SD', NULL, 0, '', 206),
(207, 'Suriname', 'SR', NULL, 0, '', 207),
(208, 'Svalbard and Jan Mayen Islands', 'SJ', NULL, 0, '', 208),
(209, 'Swaziland', 'SZ', NULL, 0, '', 209),
(210, 'Sweden', 'SE', NULL, 0, '', 210),
(211, 'Switzerland', 'CH', NULL, 0, '', 211),
(212, 'Syrian Arab Republic', 'SY', NULL, 0, '', 212),
(213, 'Taiwan', 'TW', NULL, 0, '', 213),
(214, 'Tajikistan', 'TJ', NULL, 0, '', 214),
(215, 'Tanzania, United Republic of', 'TZ', NULL, 0, '', 215),
(216, 'Thailand', 'TH', NULL, 0, '', 216),
(217, 'Togo', 'TG', NULL, 0, '', 217),
(218, 'Tokelau', 'TK', NULL, 0, '', 218),
(219, 'Tonga', 'TO', NULL, 0, '', 219),
(220, 'Trinidad and Tobago', 'TT', NULL, 0, '', 220),
(221, 'Tunisia', 'TN', NULL, 0, '', 221),
(222, 'Turkey', 'TR', NULL, 0, '', 222),
(223, 'Turkmenistan', 'TM', NULL, 0, '', 223),
(224, 'Turks and Caicos Islands', 'TC', NULL, 0, '', 224),
(225, 'Tuvalu', 'TV', NULL, 0, '', 225),
(226, 'Uganda', 'UG', NULL, 0, '', 226),
(227, 'Ukraine', 'UA', NULL, 0, '', 227),
(228, 'United Arab Emirates', 'AE', NULL, 0, '', 228),
(229, 'United Kingdom', 'GB', NULL, 0, '', 229),
(230, 'United States', 'US', NULL, 0, '', 230),
(231, 'United States minor outlying islands', 'UM', NULL, 0, '', 231),
(232, 'Uruguay', 'UY', NULL, 0, '', 232),
(233, 'Uzbekistan', 'UZ', NULL, 0, '', 233),
(234, 'Vanuatu', 'VU', NULL, 0, '', 234),
(235, 'Vatican City State', 'VA', NULL, 0, '', 235),
(236, 'Venezuela', 'VE', NULL, 0, '', 236),
(237, 'Vietnam', 'VN', NULL, 0, '', 237),
(238, 'Virgin Islands (British)', 'VG', NULL, 0, '', 238),
(239, 'Virgin Islands (U.S.)', 'VI', NULL, 0, '', 239),
(240, 'Wallis and Futuna Islands', 'WF', NULL, 0, '', 240),
(241, 'Western Sahara', 'EH', NULL, 0, '', 241),
(242, 'Yemen', 'YE', NULL, 0, '', 242),
(243, 'Zaire', 'ZR', NULL, 0, '', 243),
(244, 'Zambia', 'ZM', NULL, 0, '', 244),
(245, 'Zimbabwe', 'ZW', NULL, 0, '', 245);
...
CREATE TABLE IF NOT EXISTS `enderecos` (
  `endereco_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária',
  ...
  UNIQUE KEY `uk_enderecos` (`entidade_id`,`associado_id`,`equipe_id`),
  KEY `fk_enderecos_associado` (`associado_id`),
  KEY `fk_enderecos_tipoendereco` (`tipoendereco_id`),
...
CREATE TABLE IF NOT EXISTS `entidades` (
  `Entidade_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária de Empresa/clube/associação/agremiação',
  ...
  KEY `UK_Entidades` (`NomeAgregado`,`RazaoSocial`),
  KEY `fk_entidades_tiposentidades` (`TipoEntidade_id`),
  KEY `fk_entidades_associados1` (`Associado_Id`),
  KEY `fk_entidades_associados2` (`RespAdministrativo`),
  KEY `fk_entidades_associados3` (`AuxAdministrativo`)
...
CREATE TABLE IF NOT EXISTS `equipes` (
  `equipe_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária',
  ...
  KEY `fk_equipes_categoriafutebol` (`categoria_id`),
  KEY `fk_equipes_tipofutebol` (`tipofutebol_id`),
  KEY `fk_equipes_entidade` (`entidade_id`),
  KEY `fk_equipes_associados1` (`responsavel_id`),
  KEY `fk_equipes_associados2` (`administrador_id`)
...
CREATE TABLE IF NOT EXISTS `equipes_complemento` (
  ...
  PRIMARY KEY (`equipecompl_id`),
  KEY `fk_equipescompl_associado1` (`tecnico_id`),
  KEY `fk_equipescompl_associado2` (`auxiliar_id`)
...
CREATE TABLE IF NOT EXISTS `equipe_jogadores` (
  ...
  PRIMARY KEY (`EquipeJogador_Id`),
  UNIQUE KEY `UK_equipesjogadores` (`Jogador_Id`,`Equipe_Id`),
  KEY `fk_equipes` (`Equipe_Id`),
  KEY `fk_posicao1` (`Posicao_id1`),
  KEY `fk_posicao2` (`Posicao_id2`),
  KEY `fk_posicao3` (`Posicao_id3`)
...
CREATE TABLE IF NOT EXISTS `estados` (
  `Estado_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave da Tabela Estados',
...
CREATE TABLE IF NOT EXISTS `eventos_jogo` (
  ...
  PRIMARY KEY (`Jogo_Id`),
  KEY `fk_eventsojogo_Equipe` (`Equipe_Id`),
  KEY `fk_eventosJogo_TipoEvento` (`Tipoevento_id`)
...
INSERT INTO `genders` (`id`, `name`, `lang`, `ido`) VALUES
(1, 'Masculino', 'en', 1),
(2, 'Feminino', 'en', 2),
(3, 'Female', 'us', 2);
...
INSERT INTO `grounds` (`id`, `name`, `lang`, `players`, `ido`) VALUES
(1, 'Campo', 'en', 11, 1),
(2, 'Grass', 'br', 11, 1),
(3, 'teste', 'en', 2, 3);
...
CREATE TABLE IF NOT EXISTS `jogadores` (
  `jogador_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária',
  ...
  KEY `fk_jogador_associado` (`associado_id`),
  KEY `fk_jogador_tipofutebol` (`TipoFutebol_id`)
...
CREATE TABLE IF NOT EXISTS `jogador_posição` (
  ...
  UNIQUE KEY `uk_jogadorposicao` (`Associado_id`,`tipofutebol_id`,`Preferencia`),
  KEY `pk_jogadorposicao` (`tipofutebol_id`,`jogador_id`,`tipofutebolposicao_id`),
  KEY `fk_jogadorposicao_tipofutebolposical` (`tipofutebolposicao_id`)
...
CREATE TABLE IF NOT EXISTS `jogo` (
  `Jogo_Id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária',
  ...
  PRIMARY KEY (`Jogo_Id`),
  UNIQUE KEY `uk_jogo` (`DtJogo`,`Equipe_Id`,`Equipe_Id_convidada`),
  KEY `fk_Jogo_Equipe1` (`Equipe_Id`),
  KEY `fk_Jogo_Equipe2` (`Equipe_Id_convidada`)
...
CREATE TABLE IF NOT EXISTS `operadoras_telefone` (
  `Operadora_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária',
...
CREATE TABLE IF NOT EXISTS `paises` (
  `Pais_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária',
...
CREATE TABLE IF NOT EXISTS `players` (
  ...
  `picture` varchar(1000) DEFAULT 'player_avatar.png',
  `ground` int(11) DEFAULT NULL,
  `position` int(11) NOT NULL,
  `open_for_invites` int(11) NOT NULL DEFAULT '0',
  `looking_teams` int(11) DEFAULT '0',
...
INSERT INTO `players` (`player_id`, `user_id`, `alias`, `picture`, `ground`, `position`, `open_for_invites`, `looking_teams`) VALUES
(10, 5, 'Caio12', '1478185779275-images.jpg', 1, 4, 1, 1),
(11, 4, 'Caio Matador', 'player_avatar.png', 1, 0, 0, 0);
...
INSERT INTO `positions` (`id`, `name`, `description`, `lang`, `ground_id`, `ido`) VALUES
(4, 'Lateral Direito', 'Ala ou Lateral, atuando pela Direita', 'en', 1, 4);
...
CREATE TABLE IF NOT EXISTS `seguidores` (
  ...
  UNIQUE KEY `uk_seguidor` (`associado_Id`,`entidade_Id`,`Equipe_Id`,`Jogador_Id`),
  KEY `fk_seguidor_entidade` (`entidade_Id`),
  KEY `fk_seguidor_equipe` (`Equipe_Id`),
  KEY `fk_seguidor_jogador` (`Jogador_Id`)
...
CREATE TABLE IF NOT EXISTS `sexos` (
  `Sexo_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'chave primaria',
...
INSERT INTO `states` (`id`, `name`, `abr`, `country_id`, `lang`, `ido`) VALUES
(1, 'Acre', 'AC', 30, 'en', 1),
(2, 'Alagoas', 'AL', 30, 'en', 2),
(3, 'Amazonas', 'AM', 30, 'en', 3),
(4, 'Amapá', 'AP', 30, 'en', 4),
(5, 'Bahia', 'BA', 30, 'en', 5),
(6, 'Ceará', 'CE', 30, 'en', 6),
(7, 'Distrito Federal', 'DF', 30, 'en', 7),
(8, 'Espírito Santo', 'ES', 30, 'en', 8),
(9, 'Goiás', 'GO', 30, 'en', 9),
(10, 'Maranhão', 'MA', 30, 'en', 10),
(11, 'Minas Gerais', 'MG', 30, 'en', 11),
(12, 'Mato Grosso do Sul', 'MS', 30, 'en', 12),
(13, 'Mato Grosso', 'MT', 30, 'en', 13),
(14, 'Pará', 'PA', 30, 'en', 14),
(15, 'Paraíba', 'PB', 30, 'en', 15),
(16, 'Pernambuco', 'PE', 30, 'en', 16),
(17, 'Piauí', 'PI', 30, 'en', 17),
(18, 'Paraná', 'PR', 30, 'en', 18),
(19, 'Rio de Janeiro', 'RJ', 30, 'en', 19),
(20, 'Rio Grande do Norte', 'RN', 30, 'en', 20),
(21, 'Rondônia', 'RO', 30, 'en', 21),
(22, 'Roraima', 'RR', 30, 'en', 22),
(23, 'Rio Grande do Sul', 'RS', 30, 'en', 23),
(24, 'Santa Catarina', 'SC', 30, 'en', 24),
(25, 'Sergipe', 'SE', 30, 'en', 25),
(26, 'São Paulo', 'SP', 30, 'en', 26),
(27, 'Tocantins', 'TO', 30, 'en', 27);

-- --------------------------------------------------------

--
-- Table structure for table `team_followers`
--
...
CREATE TABLE IF NOT EXISTS `tipofutebol_posicao` (
  `tipofutebolposicao_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ChavePrimária',
  ...
  KEY `pk_tipofutebolposicao` (`tipofutebolposicao_id`),
  KEY `FK_tipofutebolposicao_tipofutebol` (`tipofutebol_id`),
  KEY `uk_tipofutebolposicao` (`posicao_id`,`tipofutebol_id`)
...
CREATE TABLE IF NOT EXISTS `tipos_endereco` (
  `Tipoendereco_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária',
...
CREATE TABLE IF NOT EXISTS `tipos_entidades` (
  `TipoEntidade_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária',
  `Descrição` varchar(50) NOT NULL COMMENT 'Chave Única',
  PRIMARY KEY (`TipoEntidade_id`),
  UNIQUE KEY `UK_Tipos_entidades` (`Descrição`)
...
CREATE TABLE IF NOT EXISTS `tipos_evento` (
  `tipoevento_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária',
...
CREATE TABLE IF NOT EXISTS `tipos_futebol` (
  `tipofutebol_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primaria',
  ...
  KEY `pk_tipofutebol` (`tipofutebol_id`)
...
CREATE TABLE IF NOT EXISTS `tipos_telefone` (
  `Telefone_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave Primária',
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `created_at`, `status`, `gender`, `born`, `cpf`, `passport`, `nationality`, `phone_a_number`, `phone_a_carrier`, `phone_b_number`, `phone_b_carrier`, `phone_c_number`, `phone_c_carrier`, `photo`, `address`, `city`, `state`, `country`, `first_name`, `middle_name`, `last_name`, `is_player`) VALUES
(4, '', '$2a$10$6NTebGqdp0Nru4W3nARgbuc.xXGXpZMpJfkJFhJvJJ6zxAKcmUrUu', 'a@a', '2016-11-03 16:20:04', 0, 0, '1999-03-16', '', '', '1', '', '', '', '', '', '', '', '', 0, 0, 30, 'dasda', 'das', '', 1),
(5, 'caiomelzer', '$2a$10$kDIfVfO4fAmcTCMvxYGBzuc40xSHNzf/486k8eU5TxzcUgFW3Wi7y', 'melzer.caio@gmail.com', '2016-11-03 11:42:52', 0, 1, '1989-03-16', '37130262893', '', '30', '', '', '', '', '', '', '', 'Rua teste', 5270, 26, 30, 'Caio', 'Melzer', 'Oliveira', 1),
(6, '', '$2a$10$9Oi6iSxsJqxBLp7BpZyZP.XI4qF5Tu3bcNJYQOqHAO2RBVYzBXc/K', 'teste@teste.com', '2016-11-03 15:36:45', 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, '', '', '', 0);
...
--
-- Stand-in structure for view `vw_cities`
--
DROP VIEW IF EXISTS `vw_cities`;
CREATE TABLE IF NOT EXISTS `vw_cities` (
`lang` varchar(4)
...
--
DROP VIEW IF EXISTS `vw_players`;
CREATE TABLE IF NOT EXISTS `vw_players` (
`player_id` int(11)
,`user_id` int(11)
,`alias` varchar(100)
...
,`nationality` text
,`phone_a_number` text
,`phone_a_carrier` text
,`phone_b_number` text
,`phone_b_carrier` text
,`phone_c_number` text
,`phone_c_carrier` text
,`photo` text
,`address` text
,`city` int(11)
,`state` int(11)
...
--
-- Stand-in structure for view `vw_users_tmp`
--
DROP VIEW IF EXISTS `vw_users_tmp`;
CREATE TABLE IF NOT EXISTS `vw_users_tmp` (
`id` int(10) unsigned
,`username` varchar(20)
,`password` char(60)
,`email` text
...
--
-- Structure for view `vw_cities`
--
DROP TABLE IF EXISTS `vw_cities`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_cities`  AS  select `countries`.`lang` AS `lang`,`cities`.`name` AS `city_name`,`states`.`name` AS `state_name`,`countries`.`name` AS `country_name`,`cities`.`id` AS `city_id`,`states`.`id` AS `state_id`,`countries`.`id` AS `country_id` from ((`cities` join `states` on((`cities`.`state_id` = `states`.`id`))) join `countries` on((`states`.`country_id` = `countries`.`id`))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_players`  AS  select `players`.`player_id` AS `player_id`,`players`.`user_id` AS `user_id`,`players`.`alias` AS `alias`,`players`.`picture` AS `picture`,`players`.`ground` AS `ground`,`positions`.`name` AS `position_name`,`grounds`.`name` AS `ground_name`,`positions`.`name` AS `position_id`,`grounds`.`id` AS `ground_id` from (((`vw_users_tmp` left join `players` on((`vw_users_tmp`.`id` = `players`.`user_id`))) join `grounds` on((`grounds`.`id` = `players`.`ground`))) join `positions` on((`positions`.`ground_id` = `grounds`.`id`))) where (`vw_users_tmp`.`is_player` = 1) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_users`  AS  select `vw_users_tmp`.`id` AS `id`,`vw_users_tmp`.`username` AS `username`,`vw_users_tmp`.`password` AS `password`,`vw_users_tmp`.`email` AS `email`,`vw_users_tmp`.`created_at` AS `created_at`,`vw_users_tmp`.`status` AS `status`,`vw_users_tmp`.`gender` AS `gender`,`vw_users_tmp`.`born` AS `born`,`vw_users_tmp`.`cpf` AS `cpf`,`vw_users_tmp`.`passport` AS `passport`,`vw_users_tmp`.`nationality` AS `nationality`,`vw_users_tmp`.`phone_a_number` AS `phone_a_number`,`vw_users_tmp`.`phone_a_carrier` AS `phone_a_carrier`,`vw_users_tmp`.`phone_b_number` AS `phone_b_number`,`vw_users_tmp`.`phone_b_carrier` AS `phone_b_carrier`,`vw_users_tmp`.`phone_c_number` AS `phone_c_number`,`vw_users_tmp`.`phone_c_carrier` AS `phone_c_carrier`,`vw_users_tmp`.`photo` AS `photo`,`vw_users_tmp`.`address` AS `address`,`vw_users_tmp`.`city` AS `city`,`vw_users_tmp`.`state` AS `state`,`vw_users_tmp`.`country` AS `country`,`vw_users_tmp`.`first_name` AS `first_name`,`vw_users_tmp`.`middle_name` AS `middle_name`,`vw_users_tmp`.`last_name` AS `last_name`,`vw_users_tmp`.`is_player` AS `is_player`,`vw_users_tmp`.`lang` AS `lang`,`vw_users_tmp`.`city_name` AS `city_name`,`vw_users_tmp`.`state_name` AS `state_name`,`vw_users_tmp`.`country_name` AS `country_name`,`vw_users_tmp`.`city_id` AS `city_id`,`vw_users_tmp`.`state_id` AS `state_id`,`vw_users_tmp`.`country_id` AS `country_id`,`vw_users_tmp`.`nationality_name` AS `nationality_name`,`vw_users_tmp`.`genders_name` AS `genders_name`,`vw_players`.`player_id` AS `player_id`,`vw_players`.`user_id` AS `user_id`,`vw_players`.`alias` AS `alias`,`vw_players`.`picture` AS `picture`,`vw_players`.`ground` AS `ground`,`vw_players`.`position_name` AS `position_name`,`vw_players`.`ground_name` AS `ground_name`,`vw_players`.`position_id` AS `position_id`,`vw_players`.`ground_id` AS `ground_id`,timestampdiff(YEAR,`vw_users_tmp`.`born`,curdate()) AS `age` from (`vw_users_tmp` left join `vw_players` on((`vw_players`.`user_id` = `vw_users_tmp`.`id`))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_users_tmp`
--
DROP TABLE IF EXISTS `vw_users_tmp`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_users_tmp`  AS  select `users`.`id` AS `id`,`users`.`username` AS `username`,`users`.`password` AS `password`,`users`.`email` AS `email`,`users`.`created_at` AS `created_at`,`users`.`status` AS `status`,`users`.`gender` AS `gender`,`users`.`born` AS `born`,`users`.`cpf` AS `cpf`,`users`.`passport` AS `passport`,`users`.`nationality` AS `nationality`,`users`.`phone_a_number` AS `phone_a_number`,`users`.`phone_a_carrier` AS `phone_a_carrier`,`users`.`phone_b_number` AS `phone_b_number`,`users`.`phone_b_carrier` AS `phone_b_carrier`,`users`.`phone_c_number` AS `phone_c_number`,`users`.`phone_c_carrier` AS `phone_c_carrier`,`users`.`photo` AS `photo`,`users`.`address` AS `address`,`users`.`city` AS `city`,`users`.`state` AS `state`,`users`.`country` AS `country`,`users`.`first_name` AS `first_name`,`users`.`middle_name` AS `middle_name`,`users`.`last_name` AS `last_name`,`users`.`is_player` AS `is_player`,`vw_cities`.`lang` AS `lang`,`vw_cities`.`city_name` AS `city_name`,`vw_cities`.`state_name` AS `state_name`,`vw_cities`.`country_name` AS `country_name`,`vw_cities`.`city_id` AS `city_id`,`vw_cities`.`state_id` AS `state_id`,`vw_cities`.`country_id` AS `country_id`,`countries`.`name` AS `nationality_name`,`genders`.`name` AS `genders_name` from (((`users` left join `vw_cities` on((`vw_cities`.`city_id` = `users`.`city`))) left join `countries` on((`countries`.`id` = `users`.`nationality`))) left join `genders` on((`users`.`gender` = `genders`.`id`))) ;
